...
\thesistitle{Investigating the Impact of Various Feature Extraction Algorithms on Performance in Automatic Speech Recognition Systems\newline \\
	\large \emph{To What Extent Do Mel-Frequency Cepstrum Coefficients Outperform Other Speech Feature Extraction Algorithms in Speech Recognition Neural Networks?}}
...
{\scshape \degreename\par}\vspace{1.5cm} % University name
...
{\large \today}\\[1cm] % Date
\large{3680 Words}\\[2cm] % Word count
